...
library LibVerification {
    ...
    bytes32 internal constant BARZ_MSG_TYPEHASH =
        0xb1bcb804a4a3a1af3ee7920d949bdfd417ea1b736c3552c8d6563a229a619100;
    ...
    function encodeMessageData(
        ...
        bytes32 messageHash = keccak256(
            abi.encode(BARZ_MSG_TYPEHASH, keccak256(message))
        );
